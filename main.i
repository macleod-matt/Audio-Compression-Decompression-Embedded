...
int main(int argc, char **argv){
    ...
    if (getcwd(cwd, sizeof(cwd)) != ((void *)0)) {
        ...
        compression_time = (double) ((double) stop - (double) start) / 1000000l;

        start2 = clock();

        encode_wave_file(compressedFileName,decompressedFileName, (0));

        stop2 = clock();

        decompression_time = (double) ((double)stop - (double)start) / 1000000l;
