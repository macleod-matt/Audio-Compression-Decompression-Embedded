...
int encode_wave_file(char* inFileName, char* outFileName, _Bool encodeType);
# 8 "mulawAPI.h" 2
# 30 "mulawAPI.h"
...
int encode_wave_file(char* input_file_name, char* output_file_name, _Bool encodeType){
 ...
 unsigned char *inputfile_data_buffer, *output_file_data_buffer;
    ...
    unsigned int byteRate = (sampleRate * numChannels * 8) / 8;
    ...
    unsigned int blockAlign = (numChannels * 8) / 8;
    ...
    if (encodeType == (1)){
        ...
        for (i = 0; i < overall_size; i = i + 8) {
            ...
            input_data1 = inputfile_data_buffer[i] | inputfile_data_buffer[i + 1] << 8;
            input_data2 = inputfile_data_buffer[i + 2] | inputfile_data_buffer[i + 3] << 8;
            input_data3 = inputfile_data_buffer[i + 4] | inputfile_data_buffer[i + 5] << 8;
            input_data4 = inputfile_data_buffer[i + 6] | inputfile_data_buffer[i + 7] << 8;

            codeword1 = codeword_compression(input_data1,(input_data1 & 0x2000));
            codeword2 = codeword_compression(input_data2,(input_data2 & 0x2000));
            codeword3 = codeword_compression(input_data3,(input_data3 & 0x2000));
            codeword4 = codeword_compression(input_data4,(input_data4 & 0x2000));
    ...
    if (encodeType == (0)){
        ...
        for (i = 0; i < overall_size; i = i + 8) {
            ...
            input_data1 = inputfile_data_buffer[i] | inputfile_data_buffer[i + 1] << 6;
            input_data2 = inputfile_data_buffer[i + 2] | inputfile_data_buffer[i + 3] << 6;
            input_data3 = inputfile_data_buffer[i + 4] | inputfile_data_buffer[i + 5] << 6;
            input_data4 = inputfile_data_buffer[i + 6] | inputfile_data_buffer[i + 7] << 6;
